...
@Component({
  selector: 'ngx-form-cfondoreserva',
  styleUrls: ['./form-cfondoreserva.component.scss'],
  templateUrl: './form-cfondoreserva.component.html',
})
export class FormcfondoreservaComponent {
