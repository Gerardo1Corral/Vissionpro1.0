...
@Component({
  selector: 'ngx-form-cremuneraciones',
  styleUrls: ['./form-cremuneraciones.component.scss'],
  templateUrl: './form-cremuneraciones.component.html',
})
export class FormcremuneracionesComponent {
