...
@Component({
  selector: 'ngx-form-cgastocomun',
  styleUrls: ['./form-cgastocomun.component.scss'],
  templateUrl: './form-cgastocomun.component.html',
})
export class FormcgastocomunComponent {
